...
def test_01_05(url):
    with SB(
        ...
        sb.click('button:contains("Add network")')
        buttons = sb.find_elements('button:contains("Add")')
        buttons[5].click()
        sb.click('button:contains("Approve")')
        sb.click('button:contains("Switch to Polygon Mainnet")')
        sb.open_new_window()
        sb.sleep(5)
        ...
        sb.sleep(7)
        sb.switch_to_window(4)
        sb.click('button:contains("Switch network")')
        sb.sleep(30)
        sb.click('button:contains("Refuse")')
        sb.sleep(60)

if __name__ == "__main__":
    test_01_05("https://development.arttaca.io/nft/datng/1")
