...
def tc_01_01(url):
    with SB(
        ...
        sb.sleep(7)
        sb.type('input[name="email"]',"datnat264@gmail.com")
        sb.type('input[placeholder="1234 1234 1234 1234"]',"4242 4242 4242 4242")
        sb.type('input[placeholder="MM / YY"]',"0805")
        sb.type('input[placeholder="CVC"]',"086")
        sb.type('input[placeholder="Full name on card"]',"hieutran")
        sb.sleep(30)
