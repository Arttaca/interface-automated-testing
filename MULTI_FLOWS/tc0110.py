...
def test_01_10():
    with SB(
        ...
        sb.type('input[data-testid="import-srp__srp-word-0"]',"token")
        sb.type('input[data-testid="import-srp__srp-word-1"]',"hunt")
        sb.type('input[data-testid="import-srp__srp-word-2"]',"broom")
        sb.type('input[data-testid="import-srp__srp-word-3"]',"equip")
        sb.type('input[data-testid="import-srp__srp-word-4"]',"auction")
        sb.type('input[data-testid="import-srp__srp-word-5"]',"ticket")
        sb.type('input[data-testid="import-srp__srp-word-6"]',"kiss")
        sb.type('input[data-testid="import-srp__srp-word-7"]',"peanut")
        sb.type('input[data-testid="import-srp__srp-word-8"]',"blush")
        sb.type('input[data-testid="import-srp__srp-word-9"]',"clutch")
        sb.type('input[data-testid="import-srp__srp-word-10"]',"coil")
        sb.type('input[data-testid="import-srp__srp-word-11"]',"taste")
